// Nephi Journey (I, Nephi): a Phaser 3 platformer. Expects Phaser as a global.
//
// start(container) creates the game inside `container` and returns stop(),
// which destroys it. Phaser removes its own canvas and input listeners.
...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('nephi', new URL('../../assets/Nephi.webp', import.meta.url).href);
    this.load.image('snake', new URL('../../assets/Snake.webp', import.meta.url).href);
    this.load.image('scorpion', new URL('../../assets/Scorpion.webp', import.meta.url).href);
    this.load.image('scroll', new URL('../../assets/Scroll.webp', import.meta.url).href);
    ...
    this.load.image('guard', new URL('../../assets/Guard.webp', import.meta.url).href);
    this.load.image('laban', new URL('../../assets/Laban.webp', import.meta.url).href);
