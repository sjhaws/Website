...
- [ ] Three hearts show under the level's name; a hit greys one out, knocks Nephi back and makes him blink, and nothing hurts him while he blinks; losing the third shows a large "Out of hearts!" in the middle of the dimmed screen and goes back to level 1; each new level starts with three
