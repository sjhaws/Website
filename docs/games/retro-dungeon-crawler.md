...
- **Legacy** (in the git tag `legacy-static`): `Pages/RetroCrawler/` (`game.js`, `index.html`, `style.css`)
- **New route:** `/games/retro-dungeon-crawler`
- **Status:** rebuilt in React in `src/games/retro-dungeon-crawler/` (2026-09-18). Every **Fix** and **Decided** item below is done; use the regression checklist to test it. The legacy copy was deleted from the site on 2026-09-18.
